...
pub fn html(entries: &[TocEntry], title: &str, current: usize, selected: usize) -> String {
...
mod tests {
    ...
    fn entry(label: &str, depth: usize, spine: usize) -> TocEntry {
        TocEntry { label: label.into(), depth, spine, fragment: None }
    }
